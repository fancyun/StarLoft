...
[![Version](https://img.shields.io/badge/version-1.5.10-blue.svg)](https://github.com/starloft/kyc)
...
# 4. 放置证书
# 将证书私钥与完整证书链（含中间证书）分别命名为 privkey.pem、fullchain.pem 放入 ./certs 目录
# 证书由证书服务商（如腾讯云）签发后手动放入，可开启服务商自动续费，到期后替换文件并重启前端加载
mkdir -p certs
