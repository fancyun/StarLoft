<?php
namespace certification\zjmf_v10\logic;

/**
 * StarLoft KYC SDK（智简魔方业务系统 v10 版）
 *
 * 用于对接 StarLoft KYC 实名认证系统的 SDK 类。
 * 所有请求使用 API Key + HMAC-SHA256 签名鉴权。
 *
 * @author StarLoft
 * @version 1.0.0
 */
class KycSdk
{
    ...
    public static function classifyError($result)
    {
        ...
        if ($rawCode !== null && $rawCode !== '') {
            ...
            // 3000 需按 message 区分:5种计费拒绝 vs 2种不计费临时错误
            ...
            // 6000 FAILED / CANCELLED / TIMEOUT -> 实名终态失败(流程终止)
